package atcoderDP;  // DONT FORGET TO REMOVE THIS
...
public class FindSubset{
    ...
    void findSubSet(int index, int[] nums, List<Integer> subset) {
        if(index == nums.length) {
            ans.add(subset);
            return;
        }

        findSubSet(index+1, nums, new ArrayList<>(subset));
    ...
    void gpl(Object o, int t){out.println("Case #" + t + ": " + o);}
    void pl(Object o){out.println(o);}
    void pn(Object... o){
